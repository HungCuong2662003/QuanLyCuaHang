...
{
    public partial class FrmBaoCaoDTNHH : DevExpress.XtraEditors.XtraForm
    {
        public FrmBaoCaoDTNHH()
        {
            InitializeComponent();
        }
        public FrmBaoCaoDTNHH(tb_SYS_User user, int right)
        {
            InitializeComponent();
            this._user = user;
            this._right = right;
        ...
        private void FrmBaoCaoDTNHH_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Export_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string reportPath = System.Windows.Forms.Application.StartupPath + "\\Reports\\" + "SP_DOANHTHU_THEONHOMHANG" + ".rpt";
