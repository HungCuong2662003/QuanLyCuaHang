...
namespace QL_Quan_Kho_Hang
{
    public partial class FrmXuatNB : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmXuatNB_Load(object sender, EventArgs e)
        {
            ...
            cbb_congty_chinhanh.SelectedIndexChanged += Cbb_congty_chinhanh_SelectedIndexChanged1; 
            ...
            loaddonvinhap();
            loadDvixuat();
            _lstchungTu = _chungtu.getList(2, date_tu.Value, date_den.Value.AddDays(1), cbo_dvi.SelectedValue.ToString());
        ...
        private void Cbb_congty_chinhanh_SelectedIndexChanged1(object sender, EventArgs e)
        {
            loaddonvi();
            loadDvixuat();
            loaddonvinhap();
        ...
        void chungtu_info(tb_ChungTu chungTu)
        {
            try
            {
                ...
                {
                    chungTu.MaDVI2 = cbo_dvinhap.SelectedValue.ToString();
                }
        ...
        private void luuthongtin()
        {
            try
            {
                ...
                else
                {
                    ...
                    // Cập nhật danh sách
                    _lstchungTu = null;
                    _lstchungTu = _chungtu.getList(2, date_ngay.Value, date_den.Value.AddDays(1), cbo_donvixuat.SelectedValue.ToString());
                    _bdCHUNGTU.DataSource = _lstchungTu;
